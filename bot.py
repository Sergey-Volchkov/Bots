...
def commands(item):
    vk_session.method('messages.send', {'user_id': item['user_id'],
                                        'message': "Команды для бота: \n\n Для получения лолей напишите что-то из 'лоли', 'лольки', 'loli', 'лолька', 'лоля', 'лоликон'.\n \n"
                                                   ...
                                                   "Для получения лис напишите что-то из 'лиса', 'лисы', 'лисичка', 'лисички', 'фокс', 'фоксы', 'fox'.\n \n"
                                                   "Для получения сов напишите что-то из 'совы', 'совушки', 'сов', 'owl', 'owls', 'сов'.\n \n"
...
def main():
    ...
    all_commands = {'cat': [-130670107,
                    ...
                    'owl': [-113854206, ['совы', 'совушки', 'сов', 'owl', 'owls'], 'сов']}
