...
def command_for_user(user_id):
    vk_session.method('messages.send', {'user_id': user_id,
                                        'message': "Команды для бота: \n\n Для получения лолей напишите что-то из 'лоли', 'лольки', 'loli', 'лолька', 'лоля', 'лоликон'.\n \n"
                                                   ...
                                                   "Если нашли какие-то баги, нерабочую команду или что-то ещё, то сразу пишите мне.",'random_id': random.randint(-2147483648, +2147483648)})
    ...
    all_commands = {'cat': [-130670107,
                    ...
                    'dog': [-121355400,
                            ['пёсель','пес', 'собака', 'пёс', 'doge', 'песель', 'псина', 'пёсели', 'песели', 'псины',
                             ...
                             'dogs'], 'песелей'],
                    'loli': [-101072212, ['лоли', 'лольки', 'loli', 'лолька', 'лоля'], 'лолей'],
